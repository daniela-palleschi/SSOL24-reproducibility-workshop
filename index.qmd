...
1. install or update R to version 4.4.0 (Puppy Cup, 2024-04-24)
    ...
    + having an R version from 2023 or later should suffice
2. install or update RStudio
    + I am currently using RStudio version 2023.12.1+402, as I encountered issues when updating to 2024.04.2+764 in April when it was released. As a rule of thumb, I update R and/or RStudio a few months after their initial release
