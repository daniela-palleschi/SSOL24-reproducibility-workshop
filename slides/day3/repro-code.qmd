...
#| eval: false
# run manually
rbbt::bbt_update_bib(here::here("slides", "day3", "repro-code.qmd"))
```
...
::: {.content-visible when-format="revealjs"}
### Structuring and Code Chunks {.unlisted .unnumbered}
:::
...
::: {.content-visible when-format="revealjs"}
Follow the instructions on the workshop website: [https://daniela-palleschi.github.io/SSOL24-reproducibility-workshop/slides/day3/repro_code.html](https://daniela-palleschi.github.io/SSOL24-reproducibility-workshop/slides/day3/repro_code.html)
:::
